...
public class SearchTest {
    public static void main(String[] args) {
        ...
        System.out.println(Search.isLinearSearch(38, numArray));
        System.out.println(Search.isLinearSearch(9, numArray));
        System.out.println(Search.isLinearSearch(5, numArray));
